...
ADMINS_SUPER_LINE = "⭐️ {name} — главный администратор\n"
ADMINS_LINE = "👤 {name}{username}\n"
ADMINS_EMPTY = "Кроме главных администраторов пока никого нет."
ADMINS_HINT = "\nЧтобы снять администратора, нажмите на его имя."
ADD_ADMIN_PROMPT = (
    "Перешлите сюда любое сообщение от человека, которого нужно назначить администратором, "
    "или отправьте его Telegram ID числом.\n\n"
    "Отменить — /cancel"
)
ADD_ADMIN_FORWARD_HIDDEN = (
    "⚠️ У этого человека скрыт профиль при пересылке. "
    "Попросите его прислать свой ID — узнать можно у бота @userinfobot."
)
ADD_ADMIN_BAD_ID = "⚠️ Не похоже на Telegram ID. Нужно число, например 123456789."
ADD_ADMIN_SELF = "Вы и так главный администратор."
ADD_ADMIN_ALREADY = "⚠️ {name} уже администратор."
ADD_ADMIN_OK = "✅ {name} назначен администратором."
ADD_ADMIN_NOTIFY = (
    "👑 Вам выданы права администратора бота.\n\n"
    "Отправьте /admin, чтобы открыть панель управления."
)
REMOVE_ADMIN_CONFIRM = "Снять права администратора с {name}?"
REMOVE_ADMIN_OK = "✅ {name} больше не администратор."
REMOVE_ADMIN_NOTIFY = "Ваши права администратора бота отозваны."
REMOVE_ADMIN_PROTECTED = "⚠️ Главного администратора снять нельзя."
ADMIN_ONLY_SUPER = "Этот раздел доступен только главному администратору."
